...
export const translations = {
  en: {
    ...
    // Learn English
    learnEnglish: {
      badge: 'Free English Tutoring for Immigrants',
      title1: 'Master English',
      title2: 'Unlock Your Future',
      subtitle: 'Free personalised online English lessons with native speakers. A philanthropic initiative to help immigrants build confidence for work, life, and everything in between.',
      startLearning: 'Start Learning Free',
      bookTrial: 'Enrol Now - It\'s Free',
      studentsWorldwide: 'Students Helped',
      nativeTutors: 'Volunteer Tutors',
      lessonsCompleted: 'Lessons Delivered',
      satisfaction: 'Satisfaction Rate',
      whyChoose: 'Why Choose SpeakEasy?',
      poweredBy: 'Powered by',
      freeForImmigrants: '100% Free for Immigrants',
      philanthropicBadge: 'Philanthropic Initiative',
      features: {
        personalised: {
      ...
      included: {
        title: 'Everything Included - Completely Free',
        subtitle: 'No hidden fees. No credit card required. Ever.',
        features: [
      ...
      whyFreeText: 'SpeakEasy is a philanthropic initiative supported by Cognita Education. We believe language should never be a barrier to opportunity.',
      cta: {
  ...
  uk: {
    ...
    // Learn English
    learnEnglish: {
      badge: 'Безкоштовне навчання англійської для іммігрантів',
      title1: 'Опануй англійську',
      title2: 'Відкрий своє майбутнє',
      subtitle: 'Безкоштовні персоналізовані онлайн-уроки англійської з носіями мови. Благодійна ініціатива, щоб допомогти іммігрантам набути впевненості для роботи, життя та всього іншого.',
      startLearning: 'Почати безкоштовно',
      bookTrial: 'Записатися - Це безкоштовно',
      studentsWorldwide: 'Студентам допомогли',
      nativeTutors: 'Волонтерів-репетиторів',
      lessonsCompleted: 'Уроків проведено',
      satisfaction: 'Рівень задоволеності',
      whyChoose: 'Чому обирають SpeakEasy?',
      poweredBy: 'За підтримки',
      freeForImmigrants: '100% безкоштовно для іммігрантів',
      philanthropicBadge: 'Благодійна ініціатива',
      features: {
        personalised: {
      ...
      included: {
        title: 'Все включено - Повністю безкоштовно',
        subtitle: 'Без прихованих платежів. Без кредитної картки. Назавжди.',
        features: [
          'Необмежена кількість уроків з носіями мови',
          'Доступ до всіх навчальних матеріалів',
          'Відстеження прогресу та оцінювання',
          'Підбір персонального репетитора',
      ...
      whyFree: 'Чому це безкоштовно?',
      whyFreeText: 'SpeakEasy - це благодійна ініціатива за підтримки Cognita Education. Ми віримо, що мова ніколи не повинна бути перешкодою для можливостей.',
      cta: {
